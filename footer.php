		...
		<div class="container">
			...
			<div class="footer-cpy text-center">
				...
				<div class="w3layouts-agile-copyrightbottom">
					<p> <?php echo  getwebname("titles").'  '; $current=date("Y"); print_r($current);?> | Brought To You by
						<a href="https://www.youtube.com/channel/UCsFgC9ggwrmYR2XqEHXpbNg/">JOHN OKPE</a>
					</p>
